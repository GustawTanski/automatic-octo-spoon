...
var RestInterface = /** @class */ (function () {
    function RestInterface() {
        ...
        this.router.use('/feedbacks', express_1.default.json());
        this.router.get('/feedbacks', express_async_handler_1.default(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
         ...
         */
        this.router.use('/feedbacks', function (error, req, res, next) {
            if (error) {
